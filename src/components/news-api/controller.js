...
const fetchNews = async(count,callback)=>{
    ...
    await axios.get('https://www.deccanherald.com/national/coronavirus-india-news-live-updates-statewise-total-number-of-cases-deaths-statistics-lockdown-latest-news-817763.html#1')
    .then((response)=>{
